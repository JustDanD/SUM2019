...
{   
  ...
  case WM_TIMER:
    ...
    points[3].x = cos((((2 * PI) / 60) * (st.wSecond + st.wMilliseconds / 1000.0)) - (PI / 2)) *  (bm.bmWidth / 4) + 350;
    ...
    points[3].y = sin((((2 * PI) / 60) * (st.wSecond + st.wMilliseconds / 1000.0)) - (PI / 2)) *  (bm.bmHeight / 4) + 350;
    ...
    points2[1].x = 350;
    points2[0].x = cos((((2 * PI) / 60) * (st.wHour % 12 + st.wMinute / 60.0 + 18)) - (PI / 2) - PI / 45) * 160 + 350;
    points2[2].x = cos((((2 * PI) / 60) * (st.wHour % 12 + st.wMinute / 60.0 + 18)) - (PI / 2) + PI / 45) * 160 + 350;
    points2[3].x = cos((((2 * PI) / 60) * (st.wHour % 12 + st.wMinute / 60.0 + 18)) - (PI / 2)) *  (bm.bmWidth / 2) + 350;
    
    points2[1].y = 350;
    points2[0].y = sin((((2 * PI) / 60) * (st.wHour % 12 + st.wMinute / 60.0 + 18)) - (PI / 2) - PI / 45) * 160 + 350;
    points2[2].y = sin((((2 * PI) / 60) * (st.wHour % 12 + st.wMinute / 60.0 + 18)) - (PI / 2) + PI / 45) * 160 + 350;
    points2[3].y = sin((((2 * PI) / 60) * (st.wHour % 12 + st.wMinute / 60.0 + 18)) - (PI / 2)) *  (bm.bmHeight / 2) + 350;
    /*for (i = 1; i < 3; i++)
    {
